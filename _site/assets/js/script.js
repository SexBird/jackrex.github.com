...
$(document).pjax('#avatar, #mobile-avatar, .pl__android', '#pjax', { fragment: '#pjax', timeout: 10000 });
$(document).pjax('#avatar, #mobile-avatar, .pl__ios', '#pjax', { fragment: '#pjax', timeout: 10000 });
$(document).pjax('#avatar, #mobile-avatar, .pl__python', '#pjax', { fragment: '#pjax', timeout: 10000 });
  $(document).pjax('#avatar, #mobile-avatar, .pl__about', '#pjax', { fragment: '#pjax', timeout: 10000 });
